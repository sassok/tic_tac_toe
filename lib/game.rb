...
class Game
	#TO DO : la classe a plusieurs attr_accessor: le current_player (égal à un objet Player), le status 
  ...
  attr_accessor :current_player, :status, :Board , :arr_players
	...
	def turn
		...
		#Elle affiche le plateau, demande au joueur ce qu'il joue, vérifie si un joueur a gagné, passe au joueur suivant si la partie 
		#n'est pas finie.
		@Board.play_turn
	end
